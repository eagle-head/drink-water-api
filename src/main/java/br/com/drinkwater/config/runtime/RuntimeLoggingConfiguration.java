...
/**
 * Runtime-configurable logging properties that can be updated without application restart. Changes
 * take effect immediately when the /actuator/refresh endpoint is called.
 */
@Component
@RefreshScope
...
public class RuntimeLoggingConfiguration {
    ...
    @Pattern(
            ...
            message =
                    "Runtime logging root level must be one of: TRACE, DEBUG, INFO, WARN, ERROR, FATAL, OFF")
    ...
    @Pattern(
            regexp = "^(TRACE|DEBUG|INFO|WARN|ERROR|FATAL|OFF)$",
            message =
                    "Runtime logging app level must be one of: TRACE, DEBUG, INFO, WARN, ERROR, FATAL, OFF")
    ...
    @Pattern(
            regexp = "^(TRACE|DEBUG|INFO|WARN|ERROR|FATAL|OFF)$",
            message =
                    "Runtime logging security level must be one of: TRACE, DEBUG, INFO, WARN, ERROR, FATAL, OFF")
    ...
    @Pattern(
            regexp = "^(TRACE|DEBUG|INFO|WARN|ERROR|FATAL|OFF)$",
            message =
                    "Runtime logging oauth2 level must be one of: TRACE, DEBUG, INFO, WARN, ERROR, FATAL, OFF")
    ...
    @Pattern(
            regexp = "^(TRACE|DEBUG|INFO|WARN|ERROR|FATAL|OFF)$",
            message =
                    "Runtime logging sql level must be one of: TRACE, DEBUG, INFO, WARN, ERROR, FATAL, OFF")
    ...
    @Pattern(
            regexp = "^(TRACE|DEBUG|INFO|WARN|ERROR|FATAL|OFF)$",
            message =
                    "Runtime logging sql params level must be one of: TRACE, DEBUG, INFO, WARN, ERROR, FATAL, OFF")
    ...
    @Pattern(
            regexp = "^(TRACE|DEBUG|INFO|WARN|ERROR|FATAL|OFF)$",
            message =
                    "Runtime logging springframework level must be one of: TRACE, DEBUG, INFO, WARN, ERROR, FATAL, OFF")
