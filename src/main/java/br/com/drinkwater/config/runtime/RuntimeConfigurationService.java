 ...
 *
 * <p>The service requires a LoggingSystem bean to be available for runtime logging level changes.
...
public class RuntimeConfigurationService {
    ...
    /**
     * Applies logging configuration changes to the running application. This method is called
     * automatically when the configuration is refreshed.
     */
    ...
    public void onRefreshEvent(RefreshEvent event) {
        ...
        try {
            applyLoggingChanges();
            LOGGER.warn(
                    "Monitoring and actuator runtime configuration values were refreshed but are"
                            + " informational only. Changes to Prometheus, tracing, and actuator health"
                            + " settings require a full application restart to take effect.");
    ...
    /**
     * Manually applies logging configuration changes. Can be called directly to update logging
     * levels at runtime.
     */
    public void applyLoggingChanges() {
        ...
        setLogLevel("org.springframework.jdbc", loggingConfig.getSql());
        setLogLevel("org.hibernate.orm.jdbc.bind", loggingConfig.getSqlParams());
    ...
    /**
     * Triggers a refresh of all runtime configurations. This will publish a RefreshEvent that
     * causes all @RefreshScope beans to be recreated.
     */
        ...
        return Map.of(
                "logging",
                        Map.of(
                                ...
                                "sqlParams", loggingConfig.getSqlParams(),
    ...
    private void setLogLevel(String loggerName, String level) {
        ...
        try {
            LogLevel logLevel = LogLevel.valueOf(level.toUpperCase(Locale.ROOT).trim());
            loggingSystem.setLogLevel(loggerName, logLevel);
            LOGGER.debug("Successfully set log level for '{}' to '{}'", loggerName, logLevel);
        } catch (IllegalArgumentException e) {
            LOGGER.warn(
                    "Invalid log level '{}' for logger '{}', skipping."
                            + " Valid levels are: TRACE, DEBUG, INFO, WARN, ERROR, FATAL, OFF",
                    level,
                    loggerName);
        } catch (Exception e) {
            LOGGER.error(
                    "Failed to set log level '{}' for logger '{}': {}",
                    level,
                    loggerName,
                    e.getMessage());
        }
    ...
    private void logConfigurationSummary() {
        ...
        summary.append("=== RUNTIME CONFIGURATION SUMMARY ===")
                .append(System.lineSeparator())
                .append("Logging Levels:")
                .append(System.lineSeparator())
                .append("  Root: ")
                .append(loggingConfig.getRoot())
                .append(System.lineSeparator())
                .append("  App: ")
                .append(loggingConfig.getApp())
                .append(System.lineSeparator())
                .append("  Security: ")
                .append(loggingConfig.getSecurity())
                .append(System.lineSeparator())
                .append("  OAuth2: ")
                .append(loggingConfig.getOauth2())
                .append(System.lineSeparator())
                .append("  SQL: ")
                .append(loggingConfig.getSql())
                .append(System.lineSeparator())
                .append("  SQL Params: ")
                .append(loggingConfig.getSqlParams())
                .append(System.lineSeparator())
                .append("Monitoring:")
                .append(System.lineSeparator())
                .append("  Prometheus Step: ")
                .append(monitoringConfig.getPrometheusStep())
                .append(System.lineSeparator())
                .append("  Tracing Enabled: ")
                .append(monitoringConfig.getTracingEnabled())
                .append(System.lineSeparator())
                .append("  Tracing Sampling Rate: ")
                .append(monitoringConfig.getTracingSamplingRate())
                .append(System.lineSeparator())
                .append("Actuator:")
                .append(System.lineSeparator())
                .append("  Health Show Details: ")
                .append(actuatorConfig.getHealthShowDetails())
                .append(System.lineSeparator())
