...
/**
 * Immutable configuration properties for server settings. All properties are loaded at bootstrap
...
public record ServerProperties(
        @NotNull(message = "SERVER_PORT environment variable is required")
                @Min(
                        value = 0,
                        message =
                                "SERVER_PORT must be >= 0 (0 = random port for testing, 1024-65535 for deployment)")
