...
public final class AlarmSettingsTestConstants {
    ...
    static {
        ALARM_SETTINGS_DTO = new AlarmSettingsDTO(2000, 30, START_TIME, END_TIME);

        ALARM_SETTINGS = createAlarmSettingsFromDTO();

        EXISTING_ALARM_SETTINGS_FOR_TEST =
                new AlarmSettings(
                        500, // goal
                        60, // intervalMinutes
                        START_TIME,
    ...
    public static final AlarmSettings EXPECTED_ALARM_SETTINGS =
            new AlarmSettings(
                    ALARM_SETTINGS_DTO.goal(),
                    ALARM_SETTINGS_DTO.intervalMinutes(),
                    EXPECTED_START_TIME,
