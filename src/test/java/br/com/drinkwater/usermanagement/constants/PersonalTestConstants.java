...
public final class PersonalTestConstants {
    ...
    static {
        PERSONAL_DTO = new PersonalDTO("John", "Doe", BIRTH_DATE, BiologicalSex.MALE);

        PERSONAL = createPersonalFromDTO();

        PERSONAL_DTO_NULL_FIRST_NAME = new PersonalDTO(null, "Doe", BIRTH_DATE, BiologicalSex.MALE);

        PERSONAL_DTO_EMPTY_FIRST_NAME = new PersonalDTO("", "Doe", BIRTH_DATE, BiologicalSex.MALE);

        PERSONAL_DTO_NULL_LAST_NAME = new PersonalDTO("John", null, BIRTH_DATE, BiologicalSex.MALE);

        PERSONAL_DTO_EMPTY_LAST_NAME = new PersonalDTO("John", "", BIRTH_DATE, BiologicalSex.MALE);

        PERSONAL_DTO_NULL_BIRTH_DATE = new PersonalDTO("John", "Doe", null, BiologicalSex.MALE);

        PERSONAL_DTO_NULL_BIOLOGICAL_SEX = new PersonalDTO("John", "Doe", BIRTH_DATE, null);
    }
