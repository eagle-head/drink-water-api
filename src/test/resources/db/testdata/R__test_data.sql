-- Test data for integration and unit tests.
-- This is a repeatable migration: Flyway re-applies it whenever the checksum changes.
-- Tables are truncated before insert to guarantee a clean, deterministic state.
